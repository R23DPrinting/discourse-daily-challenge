...
# about: Fitness challenge tracking plugin — check in via hashtag or image, track progress, view leaderboards.
# version: 0.1.0
# authors: Discourse
# url: https://github.com/discourse/discourse-fitness-challenge
